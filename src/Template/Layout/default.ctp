...
<head>
    ...
    <?= $this->Html->css('CakeControlBr.bootstrap.min.css') ?>
...
<?php
    if($loguser){
?>
        <h3 class="titulo"><?php echo $this->fetch('title'). '  '.$this->element('CakeControlBr.topmenu'). '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <spam class="logado">Logado como: <strong>'. __($loguser).'</strong></spam>' ?></h3>
<?php
    }else{
